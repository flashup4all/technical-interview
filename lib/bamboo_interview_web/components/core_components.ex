defmodule BambooInterviewWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BambooInterviewWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BambooInterviewWeb.Gettext, "errors", msg, opts)
    end
  end
