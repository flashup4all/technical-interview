...
config :bamboo_interview, BambooInterviewWeb.Endpoint,
  url: [host: "localhost"],
  render_errors: [
    formats: [html: BambooInterviewWeb.ErrorHTML, json: BambooInterviewWeb.ErrorJSON],
    layout: false
  ],
...
config :bamboo_interview, BambooInterview.Mailer, adapter: Swoosh.Adapters.Local
